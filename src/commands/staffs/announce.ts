...
export default {
    ...
    execute: async ({
        ...
        const container = new ContainerBuilder().setAccentColor(undefined);
        ...
        try {
            ...
            try {
                ...
                await interaction.editReply({
                    content: `${emojis.error} There was an error sending the announcement: ${err.message}`,
                });
            } finally {
            ...
            await interaction.editReply({
                content: `${emojis.error} There was an error creating the webhook: ${err.message}`,
            });
        }
    },
};
