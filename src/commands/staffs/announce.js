	...
	execute: async ({ interaction }) => {
		...
		try {
			...
			try {
				...
				const reactions = [
					emojis.reactions.user.heart,
					emojis.reactions.user.thumbsup,
					emojis.reactions.user.thumbsdown,
					emojis.reactions.user.haha,
					emojis.reactions.user.emphasize,
					emojis.reactions.user.question,
				];
