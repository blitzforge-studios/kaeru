...
export default {
    ...
    async execute({ interaction, }) {
        ...
        try {
            ...
            const actionRow = secondComponent;
            ...
            const stringSelectMenu = selectMenu;
            const emoji = stringSelectMenu.options?.find((o) => o.value === labelValue)?.emoji ?? emojis.label.bugLabel;
            const updatedMenu = {
