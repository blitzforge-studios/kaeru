...
import { SlashCommandBuilder, PermissionFlagsBits, MessageFlags, ApplicationIntegrationType, InteractionContextType, GuildScheduledEventEntityType, GuildScheduledEventPrivacyLevel, userMention, bold, underline, } from "discord.js";
import { timezoneChecking, timeChecking, } from "../../utilities/timeChecking.js";
...
export default {
    ...
    async execute(interaction) {
        ...
        if (!(await checkAppPermissions(interaction, defaultGiveawayPermissions)))
            return;
        ...
        setTimeout(async () => {
            ...
            const desc = winner
                ? `a winner! ${emojis.giftCard}\n${userMention(winner.id)} please create a ticket to contact with us!`
        ...
        await interaction.editReply({
            content: `${emojis.giftCard} Oh, what a moment in time! I've just created a **giveaway** for you all! ${underline(giveawayName)}\nGiveaway's winner ${bold("will be shown")} when the giveaway reaches the ${underline("happening")} point in the timeline.\n-# Here is the invite link: ${inviteLink}`,
        });
    },
};
