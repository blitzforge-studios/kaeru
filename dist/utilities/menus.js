...
const ticketMenu = new StringSelectMenuBuilder()
    ...
    .setEmoji(emojis.ticketStale), new StringSelectMenuOptionBuilder()
...
const labelMenu = new StringSelectMenuBuilder()
    ...
    .setLabel("Bug")
    .setValue("label-bug")
    .setEmoji(emojis.label.bugLabel), new StringSelectMenuOptionBuilder()
    .setLabel("Reward")
    .setValue("label-reward")
    .setEmoji(emojis.label.rewardLabel), new StringSelectMenuOptionBuilder()
    .setLabel("Question")
    .setValue("label-question")
    .setEmoji(emojis.label.questionLabel), new StringSelectMenuOptionBuilder()
    .setLabel("Discussion")
    .setValue("label-discussion")
    .setEmoji(emojis.label.discussionLabel), new StringSelectMenuOptionBuilder()
    .setLabel("Help")
    .setValue("label-help")
    .setEmoji(emojis.label.helpLabel));
export const ticketMenuRow = new ActionRowBuilder().addComponents(ticketMenu);
export const labelMenuRow = new ActionRowBuilder().addComponents(labelMenu);
