export const genres = {
    traditional_pop: [
        { artist: "Mabel Matiz", query: "Mabel Matiz Gel" },
        { artist: "Tarkan", query: "Tarkan Şımarık" },
        { artist: "Ajda Pekkan", query: "Ajda Pekkan Hoş Gör Sen" },
        { artist: "Sezen Aksu", query: "Sezen Aksu Şinanay" },
        { artist: "Nilüfer", query: "Nilüfer Mor Menekşe" },
        { artist: "Edith Piaf", query: "Edith Piaf La Vie En Rose" },
        { artist: "ABBA", query: "ABBA Dancing Queen" },
        { artist: "The Beatles", query: "The Beatles Hey Jude" },
        { artist: "Celine Dion", query: "Celine Dion My Heart Will Go On" },
        { artist: "Michael Jackson", query: "Michael Jackson Billie Jean" },
        { artist: "Julio Iglesias", query: "Julio Iglesias La Cumparsita" },
        { artist: "Laura Pausini", query: "Laura Pausini La Solitudine" },
        { artist: "Bee Gees", query: "Bee Gees Stayin' Alive" },
        {
            artist: "Helene Fischer",
            query: "Helene Fischer Atemlos durch die Nacht",
        },
